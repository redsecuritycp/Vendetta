"""
Generador de reportes profesionales HTML para auditorías de seguridad.

Movido desde `report_generator.py` (root) en Fase 14 de modularización
(2026-05-14). Expone:

- `Finding` — dataclass por hallazgo
- `ScanReport` — dataclass agregada del scan completo
- `ReportGenerator` — render HTML descargable
"""
