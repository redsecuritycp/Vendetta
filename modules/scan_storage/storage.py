"""
Persistencia con SQLite para guardar scans y comparar histórico.

Movido desde `db_manager.py` (root) en Fase 14 de modularización (2026-05-14).
La ruta de la DB se resuelve al root del proyecto vendetta para mantener
compatibilidad con el symlink `vendetta.db -> shared/vendetta.db`.
"""
...
# DB vive en el root del proyecto vendetta (symlink a shared/vendetta.db).
# __file__ = .../vendetta/modules/scan_storage/storage.py
# dirname x3 = .../vendetta/
_PROJECT_ROOT = os.path.abspath(
    os.path.join(os.path.dirname(__file__), "..", "..")
)
DB_PATH = os.path.join(_PROJECT_ROOT, "vendetta.db")
