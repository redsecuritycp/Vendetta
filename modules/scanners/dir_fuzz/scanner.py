...
Movido a modules/scanners/dir_fuzz/scanner.py el 2026-05-14 (Fase 4 modular,
ver MODULAR_PLAN.md). Path antiguo `dir_fuzzer.py` queda como wrapper de
...
def main():
    ...
    if len(sys.argv) < 2:
        print("\nUso: python -m modules.scanners.dir_fuzz.scanner <url>")
        print("Ejemplo: python -m modules.scanners.dir_fuzz.scanner https://mi-sitio.com")
        sys.exit(1)
